...
class HOPOPT(NetworkProtocol):
    HOPOPTField = ('Next Header', 'Length')
    HeaderDict = {0: 'HOPOPT  IPv6 Hop-by-Hop Option',
    ...
    def __init__(self, packet):
        hopopt = unpack('!B B', packet[:2])
        self.header = HOPOPT.HeaderDict.get(hopopt[0], 'Unknown')
        self.length = hopopt[1]

    def getFields(self):
        return HOPOPT.HOPOPTField

    def getParses(self):
        parses = (self.header, self.length)
        return parses
